...
function loadQuiz(sub, difficulty) {
  if (sub === "General Knowledge" && difficulty === "medium") {
    list = [
      {
        ...
        correct: 1,
        desc: "Introduced in 1871, the Japanese yen , or JPY, is the official currency of Japan. The symbol of the yen is ¥, along with JP¥",
        image: "None",
      },
      {
        ...
        correct: 1,
        desc: "Harry Potter is a series of seven fantasy novels written by British author J. K. Rowling.",
        image: "None",
      },
      {
        ...
        image: "./images/Ahinsa_statue.jpg",
      },
      {
        question: "What is the capital city of France?",
        choices: ["Nice", "Nantes", "Bordeaux", "Paris"],
        correct: 4,
        desc: "Paris is the capital and most populous city of France. Situated on the Seine River, in the north of the country.",
        image: "None",
      },
      {
    ...
    list = [
      {
        ...
        choices: ["Kangchenjunga", "Mount Everest", "Lhotse", "	K2"],
        correct: 2,
        desc: "Common Fact",
    ...
    list = [
      ...
      {
        question:
          "What is the output of below given code snippet? <br><samp>var a=[1,2,3];<br>var b=[1,2,3]; <br>var c='1,2,3'<br>console.log(a==c)<br>console.log(b==c)<br>console.log(a==b)<br></samp><br>",
        choices: [
          "true, true, false",
          "false, false, true",
          "true, true, true",
      ...
      {
        question:
          "What is the output of below given code snippet? <br><samp>for(var i=1;i<=5;i++){<br>setTimeout(function timer(){ <br> console.log(i); <br>},i*1000);<br>}</samp><br>",
  ...
  for (let j = 0; j < num_choices; j++) {
    ...
    if (quizOver === 1) {
      if (choices[i] === list[i].correct && j + 1 === list[i].correct) {
        document.getElementById("lab" + j).innerHTML +=
...
function submit() {
  ...
  if (name != null && name != "") {
    ...
    alert(
      "Welcome " +
        name +
        " !!\nBe ready for the quiz... \nPlease don't try to reload the page while during the quiz\
 otherwise, it may result in loss of data. \n\t\tRules of the Quiz:-\n\tFor correct answer:(+5) \n\t For wrong answer:(-2)"
    );

    if (time_check == true) {
      box.innerHTML =
        '<div class="boundary"><h4 align="center"> Timer</h4><div class="progress"> <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" id="bar"></div> </div><br></div>' +
        box.innerHTML;
    ...
    body.innerHTML =
      '<div class="btn-group mr-2" id="Scroll" role="group" aria-label="Scroll"></div>';
    body.innerHTML +=
      '<br><br><div class="row text-center"><img class="rounded quest-img mx-auto d-block"></div>';
    body.innerHTML += '<br><p align="center" id="question"></p>';
    for (i = 0; i < num_choices; i++) {
      body.innerHTML +=
        '<div class="form-check"><input class="form-check-input" type="radio" name="option" id="op' +
        i +
        '"value="op' +
        i +
    ...
    body.innerHTML +=
      '<br><div class="alert alert-info" role="alert">Best of Luck</div><br><div class="row justify-content-center"><button id="clear" class="btn btn-danger">Clear Response</button>&nbsp;&nbsp;<button id="next" class="btn btn-primary">Save & Next</button>&nbsp;&nbsp;<button type="submit" id="done" class="btn btn-primary">Submit</button></div>';
